...
const Games=()=>{
    return (
        ...
        <div className='h-[90vh] w-[90vw] flex flex-col items-center justify-evenly overflow-y-auto overflow-x-hidden'>
            {games["games"].map((game, index) => (
                <Link to={"/games/"+index} className='w-[80%] h-[10vh] bg-[rgba(255,255,255,0.3)] rounded-[15px] transition-all hover:scale-[1.05]'>
