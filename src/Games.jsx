                            ...
                            <div className="w-[70%] flex flex-col justify-center items-center transition-all hover:scale-[1.05] animate-pop">
                                <Link to={"/games/"+index} className='w-full h-[10vh] bg-[rgba(255,255,255,0.25)] rounded-[15px]'>
                                    <div className='h-full w-full flex items-center justify-evenly'>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <img src={"/src/assets/"+game.winner.toLowerCase()+".png"} onerror="this.onerror=null; this.src='https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png'" className='w-8 h-8 rounded-full border-2 border-[rgba(163,158,20,0.7)]' />
                                ...
                                <div className='w-max h-min flex items-center justify-center gap-5 px-5 py-2 bg-[rgba(255,255,255,0.2)] rounded-b-[15px] border-t-2 border-t-[rgba(255,255,255,0.7)]'>
                                    {game["player"].map((player, i) => (
                                        <img src={"/src/assets/"+player.toLowerCase()+".png"} onerror="this.onerror=null; this.src='https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png'" title={player} className='w-8 h-8 rounded-full border-2 border-[rgba(255,255,255,0.4)]' />
                                    ))}
                                </div>
                            </div>
                    ))}
