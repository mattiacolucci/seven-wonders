                                ...
                                <Link to={"/games/"+game["id"]} className='w-full h-[10vh] bg-[rgba(255,255,255,0.25)] rounded-[15px]'>
                                    <div className='h-full w-full flex items-center justify-evenly'>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <img src={data.siteAssetsUrl+"/"+game.winner.toLowerCase()+".png?raw=True"} onError={(e)=>{e.target.onerror=null; e.target.src=data.siteAssetsUrl+"/user.png?raw=True"}} className='w-8 h-8 rounded-full border-2 border-[rgba(163,158,20,0.7)]' />
